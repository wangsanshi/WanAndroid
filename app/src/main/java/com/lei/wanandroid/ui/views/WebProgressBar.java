...
public class WebProgressBar extends FrameLayout {
     ...
     * 进度条颜色默认
     */
    public static String WEB_PROGRESS_COLOR = "#D81B60";
    /**
     * 进度条颜色
     */
    private int mColor;
    ...
    public WebProgressBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WebProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            WebProgressBar.this.mCurrentProgress = t;
